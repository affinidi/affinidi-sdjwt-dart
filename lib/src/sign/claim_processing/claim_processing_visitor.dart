...
class ClaimProcessingVisitor implements ClaimVisitor {
  ...
  void visitMap(MapClaimElement element, String pathPrefix) {
    ...
    while (stack.isNotEmpty) {
      final nestedElement = stack.pop();
      nestedElement.accept(this, pathPrefix);
    }

    if (element.disclosureFrame.containsKey('_sd')) {
      final fullPath = constructFullPath(pathPrefix, '_sd');
      final frameValue = element.disclosureFrame['_sd'];
